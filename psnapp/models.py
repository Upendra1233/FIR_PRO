...
class PSNEntry(models.Model):
    ...
    manager_remarks = models.TextField(max_length=120,null=True, blank=True)
    complaint_raised_by = models.CharField(max_length=100, null=True, blank=True)
    complaint_raised_name = models.CharField(max_length=100, default='')
    contact_number = models.CharField(max_length=10, null=True, blank=True)
    complaint_raised_through = models.CharField(max_length=40,null=True, blank=True)
    service_engineer_name = models.CharField(max_length=50, null=True, blank=True)
    ...
    vehicle_run = models.CharField(max_length=100, null=True, blank=True)
